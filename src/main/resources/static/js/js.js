        ...
        let bodyForm = `
            <form class="form-group text-center" id="editUser">
               ...
               <div class="form-group">
                    ...
                    <input type="text" class="form-control username" id="username" value="${user.name}" required/>
               </div>

               <div class="form-group">
                    <label for="surname" class="com-form-label">Last Name</label>
                    <input type="text" class="form-control" id="surname" value="${user.lastName}" required/>
                </div>

                <div class="form-group">
                    <label for="age" class="com-form-label">Age</label>
                    <input type="number" class="form-control" id="age" value="${user.age}" min="6" max="150" placeholder="min 6, max 150" required/>
                </div>
...
let fetchUrlUsers = "http://localhost:8083/admin/users";
let fetchUrlUser = "http://localhost:8083/user/current";
